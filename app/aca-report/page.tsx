        ...
        <div className="p-6 space-y-6 max-w-[1600px] mx-auto animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button
                        ...
                        className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white shadow-md transition-all hover:shadow-lg"
                    >
                        {isGenerating ? (
                            <>
            ...
            <div className="grid gap-4 md:grid-cols-3">
                <Card className="bg-gradient-to-br from-white to-blue-50 border-blue-100 shadow-sm">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-blue-700">{stats.totalEmployees.toLocaleString()}</div>
                        <p className="text-xs text-blue-600/80">Monthly records generated</p>
                    </CardContent>
                </Card>

                <Card className="bg-gradient-to-br from-white to-cyan-50 border-cyan-100 shadow-sm">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-cyan-900">Codes Calculated</CardTitle>
                        <Calculator className="h-4 w-4 text-cyan-600" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold text-cyan-700">{stats.codesGenerated.toLocaleString()}</div>
                        <p className="text-xs text-cyan-600/80">Line 14, 15, 16 values</p>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-gradient-to-br from-white to-emerald-50 border-emerald-100 shadow-sm">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-emerald-600/80">System operational</p>
                    </CardContent>
                </Card>
            </div>
                        ...
                        <Table>
                            <TableHeader className="bg-slate-50">
                                <TableRow>
                                    ...
                                    <TableHead className="text-center bg-blue-50/50 text-blue-700 font-semibold w-[100px]">Line 14 (Offer)</TableHead>
                                    <TableHead className="text-center bg-slate-50/50 w-[100px]">Line 15 (Cost)</TableHead>
                                    <TableHead className="text-center bg-emerald-50/50 text-emerald-700 font-semibold w-[150px]">Line 16 (Safe Harbor)</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {isLoading ? (
