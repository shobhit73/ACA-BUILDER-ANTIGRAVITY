...
-- ====================================================================
-- Script: 110-fix-final-report-join.sql
-- Purpose: Fix the JOIN condition in generate_aca_final_report.
--          Previously, it joined plan_master only on plan_code, causing
--          duplicate rows if multiple companies used the same plan code.
--          This led to "Duplicate Key" errors in the Final Report step.
-- Status: ACTIVE
-- ====================================================================
